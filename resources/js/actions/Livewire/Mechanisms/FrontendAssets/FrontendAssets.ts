...
* @route '/livewire-b678a277/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-b678a277/livewire.js',
...
* @route '/livewire-b678a277/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-b678a277/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-b678a277/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-b678a277/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
