                ...
                <div className="bg-white rounded-[2rem] shadow-xl shadow-blue-900/5 w-full max-w-[1000px] flex flex-col md:flex-row overflow-hidden relative">
                    ...
                    <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex gap-3 mb-6">
                            <a href="/auth/google" className="flex-1 flex items-center justify-center gap-2 bg-[#F8FAFC] hover:bg-gray-100 border border-gray-200 text-gray-700 text-sm py-2.5 rounded-xl font-medium transition-colors">
