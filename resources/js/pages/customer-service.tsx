    ...
    return (
        <div className="min-h-screen bg-[#f7f9fb] font-sans">
            ...
            <main className="mx-auto flex w-full max-w-[800px] flex-col gap-8 px-4 pb-12 sm:px-8">
                ...
                {flash?.success ? (
                    <div className="flex flex-col items-center rounded-3xl border border-[#e2e4e6] bg-white p-8 text-center shadow-sm sm:p-12">
                        <div className="mb-6 flex size-20 items-center justify-center rounded-full bg-[#eef5fe] text-[#1464BC]">
                            <CheckCircle2 className="h-10 w-10" />
                        </div>
                        <h2 className="mb-2 text-2xl font-bold text-[#191c1e]">
                            Laporan Terkirim!
                        </h2>
                        <p className="mx-auto mb-8 max-w-md leading-relaxed text-[#717783]">
                            Terima kasih telah menghubungi kami. Tim kami akan
                            segera menindaklanjuti pesan Anda.
                        </p>
                        <button
                            onClick={() => window.location.reload()}
                            className="rounded-xl bg-[#f2f4f6] px-6 py-3 font-bold text-[#191c1e] transition-colors hover:bg-[#e2e4e6]"
                        >
                            Kirim Laporan Baru
                        </button>
                    </div>
