 ...
 * @route '/livewire-f13ad851/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-f13ad851/upload-file',
 ...
 * @route '/livewire-f13ad851/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-f13ad851/preview-file/{filename}',
