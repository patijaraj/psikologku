...
* @route '/livewire-b678a277/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-b678a277/upload-file',
...
* @route '/livewire-b678a277/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-b678a277/preview-file/{filename}',
